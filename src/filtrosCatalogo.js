...
function esconderBebidas() {
  exibirTodos();
  const prrodutosBebida = Array.from(
...
function esconderPorcoes() {
  exibirTodos();
  const prrodutosPorcoes = Array.from(
    catalogoProdutos.getElementsByClassName("porcao")
  );
...
export function inicializarFiltros() {
  ...
  document
    .getElementById("exibir-Bebidas")
    .addEventListener("click", esconderPorcoes);
  document
    .getElementById("exibir-Porcoes")
    .addEventListener("click", esconderBebidas);
}
